...
- Save a user's playlist to their Spotify account.  Created a savePlaylist() method that writes the user's custom playlist in Steveify to their Spotify account.  This method accepts a playlist name and an array of track URIs as arguments and makes 3 requests to the Spotify API:
...
- Finally, updated the savePlaylist() method in App.js to use the new Spotify.savePlaylist() method.
